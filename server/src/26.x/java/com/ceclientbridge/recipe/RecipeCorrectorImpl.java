...
/** 26.x implementation: recipe results are ItemStackTemplate and recipes use CommonInfo/CraftingBookInfo records. */
public final class RecipeCorrectorImpl implements RecipeCorrector {
    ...
    private static ItemStackTemplate readResultField(Recipe<?> recipe) {
        try {
            Class<?> targetClass;
